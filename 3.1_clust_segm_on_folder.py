...
stop_words = False
# Output file name
output_file = "results/3.1_clust_results/clust_nmi_manifesto.csv"
...
for index_file in range(len(input_text_file_list)):
    ...
    for id_test in range(n_tests):
        ...
        result_matrix = spatial_clustering(d_ext_mat=d_ext_mat, exch_mat=exch_mat, w_mat=w_mat, n_groups=n_groups,
