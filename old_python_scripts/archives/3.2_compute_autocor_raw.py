...
input_file_list = ["CarrollLewis_AliceAdventures_ppl.txt",
                   "CarrollLewis_SylvieandBruno_ppl.txt",
                   "CarrollLewis_TheHuntingoftheSnark_ppl.txt",
                   "CarrollLewis_ThroughtheLookingGlass_ppl.txt",
                   "ShakespeareWilliam_Hamlet_ppl.txt",
                   "ShakespeareWilliam_Macbeth_ppl.txt",
                   "ShakespeareWilliam_Othello_ppl.txt",
                   "ShakespeareWilliam_RomeoandJuliet_ppl.txt",
                   "WellsHG_DoctorMoreau_ppl.txt",
                   "WellsHG_TheFirstMenintheMoon_ppl.txt",
                   "WellsHG_TheInvisibleMan_ppl.txt",
                   "WellsHG_TheTimeMachine_ppl.txt",
                   "WildeOscar_AnIdealHusband_ppl.txt",
                   "WildeOscar_TheCantervilleGhost_ppl.txt",
                   "WildeOscar_TheImportanceofBeingEarnes_ppl.txt",
                   "WildeOscar_ThePictureofDorianGray_ppl.txt"]
# Distance option
...
for sim_tag in sim_tag_list:
    ...
    # Output file name
    output_file_name = f"{base_path}/results/3.2_pplautocor{max(exch_range_window)}_{sim_tag}.csv"
    # Write header
