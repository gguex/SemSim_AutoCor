...
def compute_wn_similarities(working_path, corpus_name, verbose):
    ...
    for pos, path in pos_to_path.items():
        ...
        if dists:
            ...
            data.to_csv(base_path + "similarity_matrices/" + corpus_name[:-4] + "_" + pos_to_path[pos].split(corpus_name[:-4])[1][1:-4] + "_resnik_similarities.txt",
    ...
    for pos, path in pos_to_path.items():
        ...
        if dists:
            ...
            np.fill_diagonal(lower.values, 0.0)
            data = upper.fillna(0) + lower.fillna(0.0)
            data.to_csv(base_path + "similarity_matrices/" + corpus_name[:-4] + "_" + pos_to_path[pos].split(corpus_name[:-4])[1][1:-4] + "_wu-palmer_similarities.txt",
                        header=False, index=False, sep=";")
    ...
    for pos, path in pos_to_path.items():
        ...
        if dists:
            ...
            np.fill_diagonal(lower.values, 0.0)
            data = upper.fillna(0) + lower.fillna(0.0)
            data.to_csv(base_path + "similarity_matrices/" + corpus_name[:-4] + "_" + pos_to_path[pos].split(corpus_name[:-4])[1][1:-4] + "_leacock-chodorow_similarities.txt",
                        header=False, index=False, sep=";")
    ...
    for pos, path in pos_to_path.items():
        ...
        data.to_csv(base_path + "similarity_matrices/" + corpus_name[:-4] + "_" + pos_to_path[pos].split(corpus_name[:-4])[1][1:-4] + "_resnik_typefreq.txt",
                    header=False, index=False, sep=";")
        data.to_csv(base_path + "similarity_matrices/" + corpus_name[:-4] + "_" + pos_to_path[pos].split(corpus_name[:-4])[1][1:-4] + "_wu-palmer_typefreq.txt",
                    header=False, index=False, sep=";")
        data.to_csv(base_path + "similarity_matrices/" + corpus_name[:-4] + "_" + pos_to_path[pos].split(corpus_name[:-4])[1][1:-4] + "_leacock-chodorow_typefreq.txt",
                    header=False, index=False, sep=";")
