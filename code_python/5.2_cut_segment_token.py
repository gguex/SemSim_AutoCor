...
def compute_segment_token(working_path, input_file, sim_tag, exch_mat_opt, exch_range, n_groups, gamma, beta, kappa, conv_threshold, max_it):
...
for input_file in input_files:
    for sim_tag in sim_tags:
        compute_segment_token(working_path, input_file, sim_tag, exch_mat_opt, exch_range, n_groups, gamma, beta, kappa, conv_threshold, max_it)