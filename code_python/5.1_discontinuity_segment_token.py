...
def compute_discontinuity_segment_token(working_path, input_file, sim_tag, exch_mat_opt, exch_range, n_groups, alpha, beta, kappa, conv_threshold, max_it):
...
for input_file in input_files:
    for sim_tag in sim_tags:
        compute_discontinuity_segment_token(working_path, input_file, sim_tag, exch_mat_opt, exch_range, n_groups, alpha, beta, kappa, conv_threshold, max_it)
